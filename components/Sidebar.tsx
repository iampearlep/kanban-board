...
const Sidebar = () => {
  return (
  <div className='bg-white fixed top-0 left-0 h-screen w-64 border-r border-[#eaeaea]'>
  <div className='py-6 flex flex-col items-center gap-y-5'>
    <button className='flex flex-row gap-x-8 items-center  border border-gray-300 py-2 px-3 rounded-lg'>
    <div className='flex flex-row items-center gap-x-2'>
    <div className='px-2.5 py-1.5 text-xs font-semibold rounded-full bg-red-800 text-white'>
     A
    </div>
    <div>
        <p className='text-sm text-gray-600 font-semibold'>Aslanyan's Studio</p>
    </div>
    </div>
    <div>
